...
import com.xiaoshumiao.radom.block.DeepBlueWoodLogBlock;
import com.xiaoshumiao.radom.block.DeepBlueWoodLeavesBlock;
import com.xiaoshumiao.radom.RadomModElements;

import com.google.common.collect.ImmutableList;

@RadomModElements.ModElement.Tag
public class DeepBlueZBiome extends RadomModElements.ModElement {
	public static Biome biome;

	public DeepBlueZBiome(RadomModElements instance) {
		super(instance, 175);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-16777012).setWaterColor(-13434625).setWaterFogColor(-6710785)
						.withSkyColor(-16777012).withFoliageColor(-6710785).withGrassColor(-16763956).build();
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration(
								(new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(DeepBlueWoodLogBlock.block.getDefaultState()),
										new SimpleBlockStateProvider(DeepBlueWoodLeavesBlock.block.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("radom:deep_blue_z"));
			}
		}
	}
	...
	public void init(FMLCommonSetupEvent event) {
		...
		BiomeManager.addBiome(BiomeManager.BiomeType.ICY,
				new BiomeManager.BiomeEntry(RegistryKey.getOrCreateKey(Registry.BIOME_KEY, WorldGenRegistries.BIOME.getKey(biome)), 0));
	}
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("deep_blue_z_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("deep_blue_z_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
