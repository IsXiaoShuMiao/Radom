...
import com.xiaoshumiao.radom.block.BlueOreBlock;
import com.xiaoshumiao.radom.block.BlueLogBlock;
import com.xiaoshumiao.radom.block.BlueLeavesBlock;
import com.xiaoshumiao.radom.RadomModElements;

import com.google.common.collect.ImmutableList;

@RadomModElements.ModElement.Tag
public class BlueBiome extends RadomModElements.ModElement {
	public static Biome biome;

	public BlueBiome(RadomModElements instance) {
		super(instance, 128);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-10066177).setWaterColor(-6710785).setWaterFogColor(-3355393)
						.withSkyColor(-10066177).withFoliageColor(-16737793).withGrassColor(-13408513).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(Blocks.GRASS_BLOCK.getDefaultState(),
								BlueOreBlock.block.getDefaultState(), BlueOreBlock.block.getDefaultState())));
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(BlueLogBlock.block.getDefaultState()),
								new SimpleBlockStateProvider(BlueLeavesBlock.block.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("radom:blue"));
			}
		}
	}
