...
package com.xiaoshumiao.radom.world.biome;
...
import com.xiaoshumiao.radom.block.BlackTreeLogBlock;
import com.xiaoshumiao.radom.block.BlackTreeLeavesBlock;
import com.xiaoshumiao.radom.block.BlackOreBlock;
import com.xiaoshumiao.radom.RadomModElements;

import com.google.common.collect.ImmutableList;

@RadomModElements.ModElement.Tag
public class BlackBiome extends RadomModElements.ModElement {
	public static Biome biome;

	public BlackBiome(RadomModElements instance) {
		super(instance, 24);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-6710887).setWaterColor(-6710887).setWaterFogColor(-3355444)
						.withSkyColor(-6710887).withFoliageColor(-10066330).withGrassColor(-16777216)
						.setParticle(new ParticleEffectAmbience(ParticleTypes.FALLING_WATER, 0.005f)).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(Blocks.GRASS_BLOCK.getDefaultState(),
								BlackOreBlock.block.getDefaultState(), BlackOreBlock.block.getDefaultState())));
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(BlackTreeLogBlock.block.getDefaultState()),
								new SimpleBlockStateProvider(BlackTreeLeavesBlock.block.getDefaultState()),
				...
				biome = new Biome.Builder().precipitation(Biome.RainType.RAIN).category(Biome.Category.JUNGLE).depth(0.1f).scale(0.2f)
						.temperature(0.5f).downfall(0.7f).setEffects(effects).withMobSpawnSettings(mobSpawnInfo.copy())
						.withGenerationSettings(biomeGenerationSettings.build()).build();
				event.getRegistry().register(biome.setRegistryName("radom:black"));
			}
		}
	}
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("black_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("black_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
