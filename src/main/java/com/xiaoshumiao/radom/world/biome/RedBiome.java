...
import com.xiaoshumiao.radom.block.RedOreBlock;
import com.xiaoshumiao.radom.block.RedLogBlock;
import com.xiaoshumiao.radom.block.RedLeavesBlock;
import com.xiaoshumiao.radom.RadomModElements;

import com.google.common.collect.ImmutableList;

@RadomModElements.ModElement.Tag
public class RedBiome extends RadomModElements.ModElement {
	public static Biome biome;

	public RedBiome(RadomModElements instance) {
		super(instance, 86);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-39322).setWaterColor(-65536).setWaterFogColor(-52429)
						.withSkyColor(-39322).withFoliageColor(-65536).withGrassColor(-6750208).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(Blocks.GRASS_BLOCK.getDefaultState(),
								RedOreBlock.block.getDefaultState(), RedOreBlock.block.getDefaultState())));
				...
				event.getRegistry().register(biome.setRegistryName("radom:red"));
			}
		}
	}
