...
public class DeepBlueItem extends RadomModElements.ModElement {
	@ObjectHolder("radom:deep_blue")
	public static final Item block = null;

	public DeepBlueItem(RadomModElements instance) {
		super(instance, 132);
	}
