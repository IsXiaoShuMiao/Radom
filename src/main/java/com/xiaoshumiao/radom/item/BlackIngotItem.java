...
public class BlackIngotItem extends RadomModElements.ModElement {
	@ObjectHolder("radom:black_ingot")
	public static final Item block = null;

	public BlackIngotItem(RadomModElements instance) {
		super(instance, 1);
	}
