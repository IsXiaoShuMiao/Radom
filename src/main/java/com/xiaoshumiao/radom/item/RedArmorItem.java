...
public class RedArmorItem extends RadomModElements.ModElement {
	@ObjectHolder("radom:red_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("radom:red_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("radom:red_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("radom:red_armor_boots")
	public static final Item boots = null;

	public RedArmorItem(RadomModElements instance) {
		super(instance, 61);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(RadomItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "radom:textures/models/armor/red_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
