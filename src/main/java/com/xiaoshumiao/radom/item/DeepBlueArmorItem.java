...
public class DeepBlueArmorItem extends RadomModElements.ModElement {
	@ObjectHolder("radom:deep_blue_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("radom:deep_blue_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("radom:deep_blue_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("radom:deep_blue_armor_boots")
	public static final Item boots = null;

	public DeepBlueArmorItem(RadomModElements instance) {
		super(instance, 148);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(DeepBlueItem.block));
			}

			@OnlyIn(Dist.CLIENT)
			@Override
			public String getName() {
				return "deep_blue_armor";
			}
