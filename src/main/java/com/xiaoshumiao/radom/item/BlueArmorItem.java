...
public class BlueArmorItem extends RadomModElements.ModElement {
	@ObjectHolder("radom:blue_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("radom:blue_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("radom:blue_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("radom:blue_armor_boots")
	public static final Item boots = null;

	public BlueArmorItem(RadomModElements instance) {
		super(instance, 103);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(RadomItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "radom:textures/models/armor/blue_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
