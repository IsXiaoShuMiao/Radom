...
package com.xiaoshumiao.radom.entity;
...
import com.xiaoshumiao.radom.item.DeepBlueSwordItem;
import com.xiaoshumiao.radom.entity.renderer.UnknowRenderer;
import com.xiaoshumiao.radom.RadomModElements;

@RadomModElements.ModElement.Tag
public class UnknowEntity extends RadomModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.9f, 1.4f)).build("unknow").setRegistryName("unknow");
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletunknow").setRegistryName("entitybulletunknow");

	public UnknowEntity(RadomModElements instance) {
		super(instance, 177);
		FMLJavaModLoadingContext.get().getModEventBus().register(new UnknowRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -1, -16750849, new Item.Properties().group(RadomItemGroup.tab)).setRegistryName("unknow_spawn_egg"));
	}

	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		boolean biomeCriteria = false;
		if (new ResourceLocation("radom:deep_blue_z").equals(event.getName()))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
	...
	public static class CustomEntity extends CreeperEntity implements IRangedAttackMob {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 100;
			setNoAI(false);
			setCustomName(new StringTextComponent("Boss_Creeper"));
	...
	private static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(DeepBlueSwordItem.block);
		}
