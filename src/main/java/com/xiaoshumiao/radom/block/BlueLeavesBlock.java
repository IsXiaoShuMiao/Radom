...
public class BlueLeavesBlock extends RadomModElements.ModElement {
	@ObjectHolder("radom:blue_leaves")
	public static final Block block = null;

	public BlueLeavesBlock(RadomModElements instance) {
		super(instance, 111);
	}
