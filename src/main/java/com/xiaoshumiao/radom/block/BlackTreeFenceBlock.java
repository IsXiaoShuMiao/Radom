...
public class BlackTreeFenceBlock extends RadomModElements.ModElement {
	@ObjectHolder("radom:black_tree_fence")
	public static final Block block = null;

	public BlackTreeFenceBlock(RadomModElements instance) {
		super(instance, 31);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("black_tree_fence");
		}
