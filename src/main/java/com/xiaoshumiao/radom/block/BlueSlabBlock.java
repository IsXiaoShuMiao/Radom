...
public class BlueSlabBlock extends RadomModElements.ModElement {
	@ObjectHolder("radom:blue_slab")
	public static final Block block = null;

	public BlueSlabBlock(RadomModElements instance) {
		super(instance, 113);
	}
