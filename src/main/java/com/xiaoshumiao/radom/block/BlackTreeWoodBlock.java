...
public class BlackTreeWoodBlock extends RadomModElements.ModElement {
	@ObjectHolder("radom:black_tree_wood")
	public static final Block block = null;

	public BlackTreeWoodBlock(RadomModElements instance) {
		super(instance, 25);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("black_tree_wood");
		}
