...
public class BlueFenceGateBlock extends RadomModElements.ModElement {
	@ObjectHolder("radom:blue_fence_gate")
	public static final Block block = null;

	public BlueFenceGateBlock(RadomModElements instance) {
		super(instance, 115);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_fence_gate");
		}
