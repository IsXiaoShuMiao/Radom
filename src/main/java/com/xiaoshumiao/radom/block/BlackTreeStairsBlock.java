...
public class BlackTreeStairsBlock extends RadomModElements.ModElement {
	@ObjectHolder("radom:black_tree_stairs")
	public static final Block block = null;

	public BlackTreeStairsBlock(RadomModElements instance) {
		super(instance, 29);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("black_tree_stairs");
		}
