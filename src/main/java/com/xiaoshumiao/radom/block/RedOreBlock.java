...
import com.xiaoshumiao.radom.item.RedIngotItem;
import com.xiaoshumiao.radom.RadomModElements;

@RadomModElements.ModElement.Tag
public class RedOreBlock extends RadomModElements.ModElement {
	@ObjectHolder("radom:red_ore")
	public static final Block block = null;

	public RedOreBlock(RadomModElements instance) {
		super(instance, 46);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(RedIngotItem.block));
		}
	}
}
