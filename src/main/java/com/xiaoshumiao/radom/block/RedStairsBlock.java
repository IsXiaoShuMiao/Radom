...
public class RedStairsBlock extends RadomModElements.ModElement {
	@ObjectHolder("radom:red_stairs")
	public static final Block block = null;

	public RedStairsBlock(RadomModElements instance) {
		super(instance, 70);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			super(() -> new Block(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(12f, 8f).setLightLevel(s -> 0))
					.getDefaultState(),
