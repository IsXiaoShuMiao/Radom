...
public class DeepBlueWoodPlanksBlock extends RadomModElements.ModElement {
	@ObjectHolder("radom:deep_blue_wood_planks")
	public static final Block block = null;

	public DeepBlueWoodPlanksBlock(RadomModElements instance) {
		super(instance, 155);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(14f, 14.2298291814101f).setLightLevel(s -> 0)
					.harvestLevel(0).harvestTool(ToolType.AXE).setRequiresTool());
			setRegistryName("deep_blue_wood_planks");
		}
