...
public class BlackTreeFenceGateBlock extends RadomModElements.ModElement {
	@ObjectHolder("radom:black_tree_fence_gate")
	public static final Block block = null;

	public BlackTreeFenceGateBlock(RadomModElements instance) {
		super(instance, 32);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("black_tree_fence_gate");
		}
