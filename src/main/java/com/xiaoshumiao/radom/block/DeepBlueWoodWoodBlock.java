...
public class DeepBlueWoodWoodBlock extends RadomModElements.ModElement {
	@ObjectHolder("radom:deep_blue_wood_wood")
	public static final Block block = null;

	public DeepBlueWoodWoodBlock(RadomModElements instance) {
		super(instance, 153);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(14f, 9.486552787606733f).setLightLevel(s -> 0)
					.harvestLevel(0).harvestTool(ToolType.AXE).setRequiresTool());
			this.setDefaultState(this.stateContainer.getBaseState().with(AXIS, Direction.Axis.Y));
			setRegistryName("deep_blue_wood_wood");
		}
