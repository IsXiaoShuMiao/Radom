...
public class BlackTreePlanksBlock extends RadomModElements.ModElement {
	@ObjectHolder("radom:black_tree_planks")
	public static final Block block = null;

	public BlackTreePlanksBlock(RadomModElements instance) {
		super(instance, 27);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("black_tree_planks");
		}
