...
public class DeepBlueWoodLogBlock extends RadomModElements.ModElement {
	@ObjectHolder("radom:deep_blue_wood_log")
	public static final Block block = null;

	public DeepBlueWoodLogBlock(RadomModElements instance) {
		super(instance, 154);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("deep_blue_wood_log");
		}
