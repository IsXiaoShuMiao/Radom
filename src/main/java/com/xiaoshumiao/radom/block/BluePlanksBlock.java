...
public class BluePlanksBlock extends RadomModElements.ModElement {
	@ObjectHolder("radom:blue_planks")
	public static final Block block = null;

	public BluePlanksBlock(RadomModElements instance) {
		super(instance, 110);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(6f, 7.224674055842077f).setLightLevel(s -> 0)
					.harvestLevel(0).harvestTool(ToolType.AXE).setRequiresTool());
			setRegistryName("blue_planks");
		}
