...
public class RedPlanksBlock extends RadomModElements.ModElement {
	@ObjectHolder("radom:red_planks")
	public static final Block block = null;

	public RedPlanksBlock(RadomModElements instance) {
		super(instance, 68);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(8f, 9.09429939906239f).setLightLevel(s -> 0)
