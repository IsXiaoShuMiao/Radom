...
public class OldJarOfPickledCabbageBlockBlock extends RadomModElements.ModElement {
	@ObjectHolder("radom:old_jar_of_pickled_cabbage_block")
	public static final Block block = null;

	public OldJarOfPickledCabbageBlockBlock(RadomModElements instance) {
		super(instance, 181);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("old_jar_of_pickled_cabbage_block");
		}
