...
public class DeepBlueStoneBlock extends RadomModElements.ModElement {
	@ObjectHolder("radom:deep_blue_stone")
	public static final Block block = null;

	public DeepBlueStoneBlock(RadomModElements instance) {
		super(instance, 173);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("deep_blue_stone");
		}
