...
public class BlueButtonBlock extends RadomModElements.ModElement {
	@ObjectHolder("radom:blue_button")
	public static final Block block = null;

	public BlueButtonBlock(RadomModElements instance) {
		super(instance, 117);
	}
