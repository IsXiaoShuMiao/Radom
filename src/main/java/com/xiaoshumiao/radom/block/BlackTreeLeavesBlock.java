...
public class BlackTreeLeavesBlock extends RadomModElements.ModElement {
	@ObjectHolder("radom:black_tree_leaves")
	public static final Block block = null;

	public BlackTreeLeavesBlock(RadomModElements instance) {
		super(instance, 28);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("black_tree_leaves");
		}
