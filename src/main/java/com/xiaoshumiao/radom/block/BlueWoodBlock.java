...
public class BlueWoodBlock extends RadomModElements.ModElement {
	@ObjectHolder("radom:blue_wood")
	public static final Block block = null;

	public BlueWoodBlock(RadomModElements instance) {
		super(instance, 108);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(6f, 4.816449370561385f).setLightLevel(s -> 0)
					.harvestLevel(0).harvestTool(ToolType.AXE).setRequiresTool());
			this.setDefaultState(this.stateContainer.getBaseState().with(AXIS, Direction.Axis.Y));
			setRegistryName("blue_wood");
		}
