...
public class BlueFenceBlock extends RadomModElements.ModElement {
	@ObjectHolder("radom:blue_fence")
	public static final Block block = null;

	public BlueFenceBlock(RadomModElements instance) {
		super(instance, 114);
	}
