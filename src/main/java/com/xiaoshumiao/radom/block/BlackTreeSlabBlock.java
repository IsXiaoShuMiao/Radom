...
public class BlackTreeSlabBlock extends RadomModElements.ModElement {
	@ObjectHolder("radom:black_tree_slab")
	public static final Block block = null;

	public BlackTreeSlabBlock(RadomModElements instance) {
		super(instance, 30);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("black_tree_slab");
		}
