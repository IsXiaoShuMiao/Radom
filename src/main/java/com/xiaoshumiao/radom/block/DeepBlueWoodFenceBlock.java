...
public class DeepBlueWoodFenceBlock extends RadomModElements.ModElement {
	@ObjectHolder("radom:deep_blue_wood_fence")
	public static final Block block = null;

	public DeepBlueWoodFenceBlock(RadomModElements instance) {
		super(instance, 159);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("deep_blue_wood_fence");
		}
