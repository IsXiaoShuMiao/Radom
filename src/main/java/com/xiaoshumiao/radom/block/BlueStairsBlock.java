...
public class BlueStairsBlock extends RadomModElements.ModElement {
	@ObjectHolder("radom:blue_stairs")
	public static final Block block = null;

	public BlueStairsBlock(RadomModElements instance) {
		super(instance, 112);
	}
